...
function traedata(){
    var AppID="aa001a374bbe";
    var AppSecret="Mjk5NzkyMzQ4NjgxNDUzNTUxMTMyNjY2OTQ5MDg4MDUxMjA";
     //https://cors-anywhere.herokuapp.com/
    $.ajax({
        type: "GET",
        dataType: "json",
        url: "https://thingproxy.freeboard.io/fetch/http://webiot.com.ar:8090/api/v4/brokers",
        //url: "http://webiot.com.ar:8090/api/v4/brokers",
...
function suscription(page){
    ...
    $.ajax({
        type: "GET",
        dataType: "json",
        url: `https://thingproxy.freeboard.io/fetch/http://webiot.com.ar:8090/api/v4/subscriptions?_page=${page}&_limit=10`,
        //url: `http://webiot.com.ar:8090/api/v4/subscriptions?_page=${page}&_limit=10`,
        beforeSend: function (xhr){
          xhr.setRequestHeader('Authorization', "Basic " + btoa(AppID+":"+AppSecret));
        },
        success : function(data) {
...
function clientes(page2){
    ...
    $.ajax({
        type: "GET",
        dataType: "json",
        url: `https://thingproxy.freeboard.io/fetch/http://webiot.com.ar:8090/api/v4/clients?_page=${page2}&_limit=10`,
        //url: `http://webiot.com.ar:8090/api/v4/clients?_page=${page2}&_limit=10`,
        beforeSend: function (xhr){
