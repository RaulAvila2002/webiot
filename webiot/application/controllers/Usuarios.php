...
public function __construct(){
  ...
  public function index(){
    ...
    if ($this->session->userdata('user_tipo') == "owner"):
      $data = array('usuarios' => $this->Users_model->getUsuarios($aplicacion),);
    else:
      $data = array('usuarios' => $this->Users_model->getUsuariosProyecto($proyecto),);
    endif;
	...
	public function delete($id){
		...
		if ( ($id == 1) || ( $this->Users_model->getUsuarioTipo($id) == "admin") ){
