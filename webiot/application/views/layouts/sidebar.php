    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
       ...
       <li class="nav-item">
        ...
        <?php if (($this->session->userdata('user_tipo') == "user") || ($this->session->userdata('user_tipo') == "admin") || ($this->session->userdata('user_tipo') == "owner")):?>
        <?php echo "<li class='nav-item'>"?>
        <?php echo "  <a href='"?><?php echo base_url(); ?><?php echo "maintenance' class='nav-link'>"?>
        <?php echo "    <i class='fas fa-wrench'></i>"?>
        <?php echo "    <p>"?>
        ...
        <?php echo "</li>"?>
        <?php echo "<li class='nav-item'>"?>
        <?php echo "  <a href='"?><?php echo base_url(); ?><?php echo "logs' class='nav-link'>"?>
        <?php echo "    <i class='fas fa-clipboard'></i>"?>
        <?php echo "    <p>"?>
        <?php echo "      Logs"?>
        <?php echo "    </p>"?>
        <?php echo "  </a>"?>
        ...
        <?php echo "</li>"?>
        <?php echo "<li class='nav-item'>"?>
        <?php echo "  <a href='"?><?php echo base_url(); ?><?php echo "broker' class='nav-link'>"?>
        <?php echo "    <i class='fab fa-slideshare'></i>"?>
        <?php echo "    <p>"?>
        <?php echo "      Broker"?>
        <?php echo "    </p>"?>
        <?php echo "  </a>"?>
